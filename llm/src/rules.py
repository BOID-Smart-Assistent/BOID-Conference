...
def generate_rules(desires: str):
    ...
    5. Timeslots should be formatted as `timeslot_#timeslot_id#_#presentation_id#`.
    ...
    user_prompt = user_prompt_template.format(schedule=config.schedule.to_json(), obligations=','.join(config.user.obligations), desires=desires)
